...
class HardwareDetail : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        requestService.requestBuilderGet("user", intentClient)
            ...
            override fun onFailure(call: Call, e: IOException) {
                Toast.makeText(this@HardwareDetail, "Conversation with server fail", Toast.LENGTH_LONG).show()
            }
    ...
    fun noneAdminView(user : User, context: Context, intentUser: Int, intentClient: Int) {
        ...
        saveButton.setOnClickListener(View.OnClickListener {
            ...
            requestService.requestBuilderPut("user", user.toString())
                ...
                override fun onResponse(call: Call, response: Response) {
                    ...
                    rooterService.changeActivity(Intent(context, HardwareDetail::class.java), context, intentUser, intentClient, "idUserManaging")
                }
            })
        })
        ...
        if (levelSpinner != null) {
            ...
            val arrayAdapter = ArrayAdapter(this@HardwareDetail, android.R.layout.simple_spinner_item, levels)
