...
public class VideoGames_adapter extends BaseAdapter {

    private ArrayList<VideoGame> listData;
    private LayoutInflater layoutInflater;

    public VideoGames_adapter(Context aContext, ArrayList<VideoGame> listData) {
