...
public class GameConsoles_adapter extends BaseAdapter {

    private ArrayList<GameConsole> listData;
    private LayoutInflater layoutInflater;

    public GameConsoles_adapter(Context aContext, ArrayList<GameConsole> listData) {
