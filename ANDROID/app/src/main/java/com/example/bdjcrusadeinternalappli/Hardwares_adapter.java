...
public class Hardwares_adapter extends BaseAdapter {

    private ArrayList<Hardware> listData;
    private LayoutInflater layoutInflater;

    public Hardwares_adapter(Context aContext, ArrayList<Hardware> listData) {
